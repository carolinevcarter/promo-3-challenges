...
function run_challenges() {
  ...
  var newemail = $('#email').val('carolinevcarter@gmail.com');
  ...
  var replacedhint = $('#email-hint').html('<strong>This is my email now</strong>');
  ...
  var bkdcolor = $('th').css('background-color', '#DDF4FF')
